var App = function () {
    ...
    var handleBoxTools = function () {
        ...
        jQuery('.box .tools a.fav').click(function () {
           
            AddToFavorites(document.title, window.location.pathname + window.location.search);
    ...
    var handleDateColorpicker = function () {
        ...
        //$(".datepicker-fullscreen").pickadate();       temp waleed
        //$(".timepicker-fullscreen").pickatime();       temp waleed
        //Color picker
    ...
    var handleRaty = function () {
        $.fn.raty.defaults.path = '_content/js/jquery-raty/img';
        ...
        $('#starHalf-demo').raty({
            path: '_content/js/jquery-raty/img',
            half: true,
    ...
    var handleNestableLists = function () {
        var updateOutput = function (e) {
            ...
            if (window.JSON) {
                ...
                output.val('_content/jsON browser support required for this demo.');
            }
        };
    ...
    var handleSelect2 = function () {
        function movieFormatResult(movie) {
            ...
            if (movie.posters !== undefined && movie.posters.thumbnail !== undefined) {
                markup += "<td class='movie-image'><img src='../../js/" + movie.posters.thumbnail + "'/></td>";
            }
    ...
    var handleBackstretch = function () {
        $.backstretch([
       "_content/img/login/1.jpg"
       , "_content/img/login/2.jpg"
       , "_content/img/login/3.jpg"
       , "_content/img/login/4.jpg"
    ...
    var handleChat = function (elem) {
        var append = function () {
            ...
            msg += '<img class="media-object" alt="Generic placeholder image" src="../../js/img/chat/headshot2.jpg">';
            msg += '</a>';
    ...
    var handleTimeline = function () {
        createStoryJS({
            ...
            width: '100%',
            height: '600',
            source: '_content/js/timelinejs/example_json.json',
            embed_id: 'my-timeline',
            debug: true,
            css: '_content/js/timelinejs/css/timeline.css',
            js: '_content/js/timelinejs/js/timeline-min.js'
        });
    }
    /*-----------------------------------------------------------------------------------*/
    /*	Handle Slidernav
    ...
    var handleSliderNav = function () {
        ...
        $('#address-book .slider-content ul li ul li a').click(function (e) {
            ...
            //Set the image
            $('#contact-card .headshot img').attr('src', '_content/img/addressbook/' + img_id + '.jpg');
    ...
    var handleDashFlotCharts = function () {
        function chartMonth() {
            var data1 = [[0, 1.5], [1, 2], [2, 1], [3, 1.5], [4, 2.5], [5, 2], [6, 2], [7, 0.5], [8, 1], [9, 1.5], [10, 2], [11, 2.5], [12, 2]];
            var data2 = [[0, 2.5], [1, 3.5], [2, 2], [3, 700], [4, 4], [5, 3.5], [6, 3.5], [7, 1], [8, 2], [9, 3], [10, 4], [11, 5], [12, 4]];
    ...
    var handleThemeSkins = function () {
        ...
        var setSkin = function (color) {
            $('#skinerrr').attr("href", "/_content/css/themes/" + color + ".css");
    ...
    var handleGritter = function () {
        ...
        setTimeout(function () {
            var unique_id = $.gritter.add({
                ...
                image: '_content/img/gritter/cloud.png',
        ...
        setTimeout(function () {
            var unique_id = $.gritter.add({
                ...
                // (string | optional) the image to display on the left
                image: '_content/img/gritter/settings.png',
                // (bool | optional) if you want it to fade out on its own or just sit there
                sticky: true,
                // (int | optional) the time you want it to be alive for before fading out
                time: '',
        ...
        setTimeout(function () {
            ...
            var unique_id = $.gritter.add({
                ...
                // (string | optional) the image to display on the left
                image: '_content/img/gritter/buy.png',
                // (bool | optional) if you want it to fade out on its own or just sit there
                sticky: true,
                // (int | optional) the time you want it to be alive for before fading out
                time: '',
    ...
    return {
        ...
        blockUI: function (el, loaderOnTop) {
            lastBlockedUI = el;
            jQuery(el).block({
                message: '<img src="/_content/img/loaders/12.gif" width="100px" align="absmiddle">',
                css: {
                    border: 'none',
                    padding: '2px',
