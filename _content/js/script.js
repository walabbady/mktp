var App = function () {
	...
	/*-----------------------------------------------------------------------------------*/
		...
		d();
		$(".team-status2-toggle").click(function (y) {
            y.preventDefault();
			$('.team-status').slideUp()
            w(this);
        ...
        $("body").click(function (z) {
            ...
            if ($.inArray("team-status2", y) == -1 && $.inArray("team-status2-toggle", y) == -1 && $(z.target).parents().index($(".team-status2")) == -1 && $(z.target).parents(".team-status2-toggle").length == 0) {
                w()
            }
        });

        var w = function (y) {
            $(".team-status2").each(function () {
                var z = $(this);
                if (z.is(":visible")) {
                    var A = x(y);
                    if (A != ("#" + z.attr("id"))) {
                        $(this).slideUp(200, function () {
                            $(this).toggleClass("open");
                            $(".team-status2-toggle").each(function () {
                                var B = x(this);
                                if (B == ("#" + z.attr("id"))) {
    ...
    $("#createEventModal").modal('hide');
			    ...
			    // End Add Event Click form
			
	$(document).on('click','#deleteButton',deleteEvent);
function deleteEvent(){
    $("#createEventModal").modal('hide');
 $('#calendar').fullCalendar("removeEvents",$('#calEvent').val());
	...
	return {
        ...
        init: function () {
			...
			handleApp(); //Function to toggle team view
